...
if __name__ == '__main__':
    ...
    fig.savefig('/httpd-test/psd/marine-heatwaves/img/MHW_maps_detrend_eez.png', dpi=150, facecolor='w', edgecolor='w',
    ...
    fig.savefig(
        '/httpd-test/psd/marine-heatwaves/img/MHW_area_bar_detrend_eez.png',
